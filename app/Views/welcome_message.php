...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="http://localhost:8080/index.php/signup" target="_blank">Sign Up</a>
			</li>
			<li class="menu-item hidden"><a href="http://localhost:8080/index.php/signin" target="_blank">Sign In</a></li>
			</li>
		</ul>
	</div>
	...
	<div class="heroe">
		...
		<h1>Victors Finals Project  </h1>

		<h2>User Sign In, Sign up and Crud w/ bootstrap</h2>

	</div>
		<h1>
	 <a href ="http://localhost:8080/index.php/signup" > 
